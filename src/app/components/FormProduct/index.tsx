    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          ...
          <StyledButton
            type="button"
            style={{ padding: '0.5rem 1rem', fontSize: '0.95rem', background: '#fffbe6', border: '1.5px solid #ffd600', display: 'flex', alignItems: 'center', gap: 6 }}
      ...
      <div style={{ display: 'flex', gap: 10, marginTop: 10 }}>
        <StyledButton type="submit" disabled={loading} style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
          <FaSave />
        ...
        <StyledButton
          type="button"
          onClick={onCancel}
          style={{ background: '#eee', color: '#212121', flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}
        >
          <FaTimes />
          Cancelar
        </StyledButton>
